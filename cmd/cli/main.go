...
func init() {
	...
	grabRandomCmd.Flags().IntVar(&grabRandomFlags.MaxAttemptsPerPos, "max-attempts", 8, "number of grab attempts; depth increment is auto-computed as (rimZ-floorZ)/attempts")
